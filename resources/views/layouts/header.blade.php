            ...
            <div class="container">
                <div class="d-flex align-items-center">
                    <div class="topbar-left">
                        <a href="{{ route('home') }}" class="text-gray-110 font-size-13 hover-on-dark">Welcome to
                    ...
                    <div class="topbar-right ml-auto">
                        <ul class="list-inline mb-0">
                            ...
                            <li
                                class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                <a href="{{ route('track') }}" class="u-header-topbar__nav-link"><i
                    ...
                    <div class="col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static">
                        <div class="d-inline-flex">
                            <ul class="d-flex list-unstyled mb-0 align-items-center">
                                ...
                                <li class="col d-xl-none px-2 px-sm-3"><a href="{{route('account')}}"
                        ...
                        <div id="basicsAccordion">
                            ...
                            <div class="card border-0">
                                <div class="card-header card-collapse border-0" id="basicsHeadingOne">
                                    <button type="button"
                                        class="btn-link btn-remove-focus btn-block d-flex card-btn py-3 text-lh-1 px-4 shadow-none btn-primary rounded-top-lg border-0 font-weight-bold text-gray-90 collapse"
