                                                        ...
                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                            ...
                                                            <div id="headerSidebarPagesCollapse" class="collapse"
                                                                ...
                                                                <ul id="headerSidebarPagesMenu"
                                                                    ...
                                                                    <!-- Shop Grid -->
                                                                    <li><a class="u-header-collapse__submenu-nav-link"
                                                                            href="../shop/shop-grid.html">Shop Grid</a>
                                                                    </li>
                                                                    <!-- End Shop Grid -->
                                                        ...
                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                            ...
                                                            <div id="headerSidebarDemosCollapse" class="collapse"
                                                                ...
                                                                <ul id="headerSidebarDemosMenu"
                                                                    ...
                                                                    <!-- Compare -->
                                                                    <li><a class="u-header-collapse__submenu-nav-link"
                                                                            href="../shop/compare.html">Compare</a></li>
                                                                    <!-- End Compare -->
                ...
                <div class="">
                    ...
                    <div class="js-scrollbar u-sidebar__body">
                        <div class="u-sidebar__content u-header-sidebar__content px-4">
                                ...
                                <ul id="sidebarNav" class="list-unstyled mb-0 sidebar-navbar view-all">
                                    ...
                                    <li>
                                        <a class="dropdown-toggle dropdown-toggle-collapse" href="javascript:;"
                                            ...
                                            Gadgets<span class="text-gray-25 font-size-12 font-weight-normal">
                                                (56)</span>
                                        </a>
                            ...
                            <div class="mb-6">
                                <div class="border-bottom border-color-1 mb-5">
                                    <h3 class="section-title section-title__sm mb-0 pb-2 font-size-18">Latest Products
                                    </h3>
                                </div>
                                <ul class="list-unstyled">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                                        href="../shop/single-product-fullwidth.html">Notebook Black
                                                        Spire V Nitro VN7-591G</a></h3>
                                    ...
                                    <li class="mb-4">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <h3 class="text-lh-1dot2 font-size-14 mb-0"><a
                                                        href="../shop/single-product-fullwidth.html">Tablet Thin
                                                        EliteBook Revolve 810 G6</a></h3>
                                                <div class="text-warning text-ls-n2 font-size-16 mb-1"
                                                    style="width: 80px;">
                                                    <small class="fas fa-star"></small>
                                                    <small class="fas fa-star"></small>
