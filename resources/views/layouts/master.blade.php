                ...
                <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                    ...
                    <div class="js-scrollbar u-sidebar__body">
                        <div class="u-sidebar__content u-header-sidebar__content">
                            <form class="js-validate" method="POST" action="{{route('userlogin')}}">
                                @csrf
                                <!-- Login -->
                                <div id="login" data-target-group="idForm">
                                    ...
                                    <div class="mb-2">
                                        <button type="submit" id="loginForm"
                                            class="btn btn-block btn-sm btn-primary transition-3d-hover loginFormUser">Login</button>
                                    </div>
                            ...
                            <!-- Signup -->
                            <form class="js-validate" method="POST" action="{{ route('registered') }}">
                                @csrf
                                <div id="signup" style="display: none; opacity: 0;" data-target-group="idForm">
                                    ...
                                    <div class="form-group">
                                        <div class="js-form-message js-focus-state">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="full_name">
                                                        <span class="fas fa-user"></span>
                                                    </span>
                                                </div>
                                                <input type="text" class="form-control" name="name" id="signupName"
                                                    ...
                                                    data-msg="Please enter a Full Name." data-error-class="u-has-error"
